...
db.run('INSERT INTO chansons (titre, price, artiste_id) VALUES (?,?,?)', 'wiclef jean',3,2);
...
app.get('/',function(request, response){
 ...
 app.listen(8000,function(error){console.log ('app listening port 8000');
 } )